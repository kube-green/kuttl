...
function generate_platform {
    ...
    URL="https://github.com/kube-green/kuttl/releases/download/v${VERSION}/kuttl_${VERSION}_${1}_${ARCH}.tar.gz"
  ...
  - selector:
      matchLabels:
        os: "${1}"
        arch: "${2}"
    uri: https://github.com/kube-green/kuttl/releases/download/v${VERSION}/kuttl_${VERSION}_${1}_${ARCH}.tar.gz
    sha256: "${sha}"
    bin: "${3}"
EOF
return $TRUE
